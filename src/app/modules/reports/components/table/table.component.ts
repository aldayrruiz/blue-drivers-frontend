...
import { BillingReportService, DietReportService } from '@core/services';
import { MonthlyReportService } from '@core/services/api/monthly-report.service';
...
export class ReportsTableComponent extends BaseTableComponent<MonthlyReport, MonthlyReportRow> implements OnInit {
